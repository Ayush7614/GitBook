...
**1.**  Fork [this](https://github.com/Ayush7614/GitBook.git) repository.

**2.**  Clone your forked copy of the project.

```
git clone --depth 1 https://github.com/<your_name>/GitBook.git
```
...
```
git remote add upstream https://github.com/Ayush7614/GitBook.git
```
